/* This Script is the Final draft for basic owl
 *  function that allows for an owl to receive
 *  a gps coordinate from the "flag" owls and
 *  then take those coordinates, compare them
 *  to its own, and then lead you to the location
 *  of the initial flag owl location
 */
...
void loop() {
  ...
  while(!acquired){
    ...
    //formats message into proper lat and long coordinates
...
//////////////               radio functions            ///////////////
//functions using the radio capabilities to communicate with the other owls
void radioSetup() {
  MYNODEID = 1;
  TONODEID = 2;
...
//Bool function that send radio message and lets know if succeeded - not used in this game 
//since this script does not require sending messages only receiving them
...
//Gets the location of this seeker owl in correct format
void getLocation(){
...
//Checks to make sure that we have a location
void checkLocation(){
 ...
 *  of asterisks to represent the distance. Look around occurs within
