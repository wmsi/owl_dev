/* This software is intended to be run as a demo to simulate how the Owl's are used
 *  in a GPS-based game. On startup the Owl will display a distance to the nearest
 *  waypoint (66 ft.) Then when the "Send" button is pressed, it will release a 
 *  bearing. Press the other button at any point to hear a aural representation 
 *  of how close you are to the fake bearing.
 * 
 */
...
void demoProximity() {
    int min_distance = demo_distance;
    clearLCD();
    ...
    if(min_distance < 2) {
      ...
      writeLine(String(String(min_distance*33) + " feet"),2,0);
    }
}
